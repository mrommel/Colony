...
class PediaViewModel: ObservableObject {
    ...
    func prepare() {
        ...
        let allFeatureTextureNames = [
            ...
            "feature-mountains-se-nw", "feature-reef1", "feature-reef2", "feature-reef3", "feature-forest1",
            "feature-marsh2", "feature-mountains-sw", "feature-uluru", "feature-forest2", "feature-mountEverest",
