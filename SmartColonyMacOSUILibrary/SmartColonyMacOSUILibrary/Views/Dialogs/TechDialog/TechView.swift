        ...
        if self.viewModel.techType != .none {
            VStack(alignment: .leading, spacing: 0) {
                HStack(alignment: .top, spacing: 0) {
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        HStack(alignment: .top, spacing: 0) {
                            Text(self.viewModel.title())
                                .frame(width: 43, height: 8, alignment: .topLeading)
                                .font(.system(size: 6))
                                .padding(.leading, 1)
                                .padding(.top, 2)
                            
                            Text(self.viewModel.turnsText())
                                .frame(width: 25, height: 8, alignment: .topTrailing)
                                .font(.system(size: 6))
                                .padding(.trailing, 2)
                                .padding(.top, 2)
                        }
                    ...
                    .frame(width: 70, height: 35, alignment: .topLeading)
                    .padding(.leading, 1)
                    .padding(.top, 1)
                }
                .frame(width: 100, height: 35, alignment: .topLeading)
            ...
            .frame(width: 100, height: 45, alignment: .topLeading)
            .background(
