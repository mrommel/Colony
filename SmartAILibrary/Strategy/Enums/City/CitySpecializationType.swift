...
enum CitySpecializationType: Int, Codable {
    ...
    private func data() -> CitySpecializationTypeData {
        ...
        case .commerce: return CitySpecializationTypeData(name: "commerce", yield: .gold, isDefault: false, isWonder: false, isOperationUnitProvider: false, mustBeCoastal: false, flavors: [Flavor(type: .expansion, value: -4), Flavor(type: .culture, value: 10), Flavor(type: .production, value: 10), Flavor(type: .gold, value: 30), Flavor(type: .science, value: 10), Flavor(type: .amenities, value: 10), Flavor(type: .greatPeople, value: 5), Flavor(type: .offense, value: -4), Flavor(type: .defense, value: -4), Flavor(type: .ranged, value: -4), Flavor(type: .naval, value: -4)/*, Flavor(type: .waterConnection, value: 20)*/])

        case .science: return CitySpecializationTypeData(name: "science", yield: .science, isDefault: false, isWonder: false, isOperationUnitProvider: false, mustBeCoastal: false, flavors: [Flavor(type: .expansion, value: -4), Flavor(type: .culture, value: 10), Flavor(type: .production, value: 10), Flavor(type: .gold, value: 10), Flavor(type: .science, value: 30), Flavor(type: .amenities, value: 10), Flavor(type: .greatPeople, value: 5), Flavor(type: .offense, value: -4), Flavor(type: .defense, value: -4), Flavor(type: .ranged, value: -4), Flavor(type: .naval, value: -4)])

        case .generalEconomic: return CitySpecializationTypeData(name: "generalEconomic", yield: .production, isDefault: true, isWonder: false, isOperationUnitProvider: false, mustBeCoastal: false, flavors: [Flavor(type: .expansion, value: -4), Flavor(type: .culture, value: 30), Flavor(type: .production, value: 20), Flavor(type: .gold, value: 20), Flavor(type: .science, value: 20), Flavor(type: .amenities, value: 20), Flavor(type: .greatPeople, value: 10), Flavor(type: .offense, value: -4), Flavor(type: .defense, value: -4), Flavor(type: .ranged, value: -4), Flavor(type: .naval, value: -4)])
        }
    }
}
