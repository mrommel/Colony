...
public enum LeaderAbilityType {
    ...
    private func data() -> LeaderAbilityTypeData {
        ...
        case .toTheWorldsEnd:
            ...
            return LeaderAbilityTypeData(
                name: "To the World's End",
                effects: [
                    "Macedonian cities never incur war weariness.", // FIXME
        ...
        case .paxBritannica:
            ...
            return LeaderAbilityTypeData(
                name: "Pax Britannica",
                effects: [
                    "The first city founded on each continent other than England's home continent grants a free melee unit in that city and +1 Trade Route capacity.", // FIXME
        ...
        case .fallOfBabylon:
            ...
            return LeaderAbilityTypeData(
                ...
                effects: [
                    "+2 Movement for all units for the next 10 turns after declaring a Surprise War.", // FIXME
                    "Declaring a Surprise War only counts as a Formal War for the purpose of Grievances and war weariness.", // FIXME
        ...
        case .giftsForTheTlatoani:
            ...
            return LeaderAbilityTypeData(
                ...
                effects: [
                    "Improved Luxury resources provide an Amenities6 Amenity to 2 extra cities.", // FIXME
                    "+1 Combat Strength for all units for each different improved Luxury resource in Aztec territory." // FIXME
                ]
            )
        ...
        case .holyRomanEmperor:
            ...
            return LeaderAbilityTypeData(
                ...
                effects: [
                    "Gain an additional Military policy slot in all Governments.", // FIXME
                    "+7 Combat Strength for all units when fighting city-states and their units." // FIXME
                ]
            )
        ...
        case .flyingSquadron:
            ...
            return LeaderAbilityTypeData(
                ...
                effects: [
                    "+1 level of Diplomatic Visibility with every encountered civilization.", // FIXME
        ...
        case .mediterraneansBride:
            ...
            return LeaderAbilityTypeData(
                ...
                effects: [
                    "International Trade Routes grant +4 Gold.", // FIXME
                    "Trade Routes sent to Egypt from other civilizations provide +2 Food for them and +2 Gold for Egypt." // FIXME
                ]
            )
        ...
        case .theGrandEmbassy:
            ...
            return LeaderAbilityTypeData(
                ...
                effects: [
                    "Trade Routes to more advanced civilizations grant Russia +1 Science for every three technologies that civilization is ahead of them, and +1 Culture for every three civics." // FIXME
                ]
            )
        }
    }
