...
public class MapOptions {
    ...
    required public init(withSize size: MapSize, type: MapType, leader: LeaderType, aiLeaders: [LeaderType] = [], handicap: HandicapType, enhanced: MapOptionsEnhanced = MapOptionsEnhanced()) {
